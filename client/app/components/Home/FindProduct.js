	    ...
	    return (
	      <div>
		      <div className="row">
		      	<div className="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-sm-offset-2 col-md-offset-2 col-lg-offset-4 col-xl-offset-4">
		      		<div className="form-group text-center">
		      			...
		      			<select className="selectpicker form-control" value={brandName} onChange={this.onBrandNameChange}>
			...
			<div className="row">
				    	<div className="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-sm-offset-2 col-md-offset-2 col-lg-offset-4 col-xl-offset-4">
				     	<div className="form-group text-center">
				      	<h4>Please Select your Model below</h4>
